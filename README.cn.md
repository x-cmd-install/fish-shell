...
合计: **181,107** 行代码（覆盖前 5 种语言、共 **2043** 个文件）。
...
- **Star**: 34,223 · **Fork**: 2,374 · **开放 issue**: 8,216 · **贡献者**: 1,074

## 累计统计

- **发布数**: 71 · **已合并 PR**: 2229 · **开放 PR**: 54 · **已关闭 issue**: 7706 · **开放 issue**: 510 · **提交数**: 23338
...
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/fish-shell.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260921.yml` · 2026-09-21T04:54:16Z._
